        ...
        <div class="col-md-7 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        @foreach($barang as $b)
                        <form class="form form-vertical" action="{{ url('update_barang/'. $b->id ) }}" method="POST" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label for="last-name-column"> Kategori Barang</label>
                                                <select name="id_kategori" id="id_kategori" class="form-control">
                                                    <option value="{{ $b->id_kategori }}"> {{ $b->id_kategori }} - {{ $b->kategori->gender }} - {{ $b->kategori->pemakai }}  - {{ $b->kategori->kat }}  - {{ $b->kategori->ukuran }}</option>
                                        ...
                                        <div class="form-group">
                                            <label for="last-name-column"> Donatur</label>
                                                <select name="id_user" id="id_user" class="form-control">
                                                    <option value="{{ $b->id }}">{{ $b->id }} - {{ $b->user->nama }}</option>
                                                    <option>
                                                        @foreach($user as $kb)
                                                        <option value="{{ $b->user->id }}">{{ $b->user->id }} - {{ $b->user->nama }}</option>
                                                        @endforeach 
                                                    </option>
                                   ...
                                   ?>
                                    <input type="text" hidden value="{{$user_login}}" name = "id_user">
                                    <div class="col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type= "text"class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="10" value="{{ $b->deskripsi }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="foto" class="form-control"
                                                 name="foto" placeholder="pilih file">
                                        </div>
                                        <div class="form-group">
                                           
                                            {{-- <label for="foto">Foto</label> --}}
                                            <img src="{{ asset('img/' .$b->foto)}}" alt="foto" width="100px">
                                            <label for="foto">Foto yang anda inputkan</label>
                                        </div>
                                    </div>
