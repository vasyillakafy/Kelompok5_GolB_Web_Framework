...
<section class="section">
    <div class="card">
        <div class="card-header">
            <a href="{{ url('tambah-admin') }}" class="btn btn-primary mb-3">Tambah Admin</a>
                            ...
                            <tbody>
                                ...
                                @foreach($admins as $admin)
                                        <tr>
                                            ...
                                            <td>{{ $admin->alamat }}</td>
                                            <td>{{ $admin->no_hp }}</td>
                                            <td><img src="{{ asset('foto/'.$admin->foto) }}" width="50px" height="50px"></td>
                                            <td>
                                            
                                            <form action="hapus-admin/{{ $admin->id }}" class="d-inline" method="POST"
