...
<link rel="stylesheet" href="{{ asset('template/dist/assets/vendors/iconly/bold.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset("template/dist/assets/css/mystyle.css") }}">
    @yield('css')
</head>
...
Dtr
            ...
            <img src="{{ asset('template/dist/assets/images/logo/grouplogo.png') }}" class="custom-brand">
    ...
    <div class="sidebar-menu">
        ...
        <li class="sidebar-item @yield('active1') ">
            ...
            <li class="sidebar-item @yield('active2') ">
                ...
                @if(auth()->user()->id_level == "2")   
            <li
                class="sidebar-item  @yield('active3')">
                <a href="{{ url('kelola_barang') }}" class='sidebar-link'>
        ...
        @endif
            {{-- <li class="sidebar-item @yield('active3') ">
                ...
                <li class="sidebar-item @yield('active6') ">
