...
<section class="section">
    <div class="card">
        <div class="card-header">
            <a href="{{ url('tambah-user') }}" class="btn btn-primary mb-3">Tambah User</a>
                            ...
                            <tbody>
                                ...
                                @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->alamat }}</td>
                                            <td>{{ $user->no_hp }}</td>
                                            <td><img src="{{ asset('img/'.$user->foto) }}" width="50px" height="50px"></td>
                                            <td>
                                            
                                            <form action="hapus-user/{{ $user->id }}" class="d-inline" method="POST"
